(function() {
    ...
    var RandomBackendForHost = function RandomBackendForHost(lru, driver, options, logHandler, debugHandler) {
        this.client = driver;
        this.lru = lru;
    ...
    RandomBackendForHost.prototype.withDebugLogging = function (targetCallback) {
        if (this.options.debug) {
            return function(message, code, backend) {
                console.warn("RandomBackendForHost: " + JSON.stringify({message: message, code: code, backend: backend}));

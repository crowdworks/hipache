(function() {
    ...
    Redis.prototype.containsOneOf = function(key, members, callback) {
    ...
    Redis.prototype.addMembersForKey = function(key, members, callback) {
        var multi = this.client.multi();
    ...
    Redis.prototype.getMembersForKey = function(key, callback) {
